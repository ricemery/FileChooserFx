...
public class FilenameComparatorTest {
   ...
   public void testOrderBySize() {
      final FilenameComparator comparator = new FilenameComparator(OrderBy.Size);
   ...
   public void testOrderByType() {
      final FilenameComparator comparator = new FilenameComparator(OrderBy.Type);
   ...
   public void testOrderByName() {
      final FilenameComparator comparator = new FilenameComparator(OrderBy.Name);
